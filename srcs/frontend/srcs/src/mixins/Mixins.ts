...
//             const response = await fetch("http://localhost:3000/users/isGuest", {
//                 method: "GET",
//                 mode: "cors",
//                 credentials: "include",
//                 headers: {
...
//             return lSignet;
//         },
//         async get_avatar(othername = ""): Promise<string> {
//             let url = "http://localhost:3000/avatar";
//             if (othername)
//                 url += "/" + othername;
...
//             return await URL.createObjectURL(myBlob);
//           },
//           async getUserInChan(): Promise<[{name: string, state: string, mode: number}] | boolean> {
//             const response = await fetch("http://localhost:3000/userInChan", {
//                 method: "GET",
//                 mode: "cors",
//                 credentials: "include",
//                 headers: {
...
//         async getMyUsername(): Promise<{username: string} | boolean> {
//             const response = await fetch("http://localhost:3000/users/MyUsername", {
//                 method: "GET",
//                 mode: "cors",
//                 credentials: "include",
//                 headers: {
